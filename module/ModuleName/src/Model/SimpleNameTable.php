...
class SimpleNameTable extends AbstractTable
{
    ...
    public function save(\ModuleName\Model\Rowset\SimpleName $rowset)
    {
    ...
    {
        if (empty($id)) {
            throw new \Exception('missing SimpleNameTable id to delete');
        }
        parent::deleteRow($id);
    }
